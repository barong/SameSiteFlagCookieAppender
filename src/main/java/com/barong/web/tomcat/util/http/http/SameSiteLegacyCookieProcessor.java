...
/**
 * Copy of https://github.com/apache/tomcat/blob/9.0.37/java/org/apache/tomcat/util/http/LegacyCookieProcessor.java
 * with custom SameSite flag appender
 */
public class SameSiteLegacyCookieProcessor extends CookieProcessorBase implements SameSiteCookieAppender {
    ...
    public SameSiteLegacyCookieProcessor() {
    ...
    public String generateHeader(Cookie cookie, HttpServletRequest request) {
        ...
        appendSameSite(sameSiteCookiesValue, buf, request);
